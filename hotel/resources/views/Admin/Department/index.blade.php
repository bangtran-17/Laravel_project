                ...
                <div class="css-1dbjc4n">
                    ...
                    <div class="css-1dbjc4n r-1awozwy r-18u37iz">
                        ...
                        <div class="css-1dbjc4n r-1awozwy r-18u37iz" data-testid="quick-links" style="padding-left: 30px;">
                            <a href="{{ Url("/admin/department/create") }}" class="css-4rbku5 r-1awozwy r-6koalj r-1q142lx r-88pszg">
                                <button class="w-20">
                            ...
                            <div class="css-1dbjc4n r-obd0qt r-13awgt0 r-18u37iz r-tzz3ar">
                                <table id="myTable">
                                    <tr class="header">
                                        ...
                                        <th style="width:25%;">LƯƠNG KHỞI ĐIỂM</th>
                                    ...
                                    <tr class="content">
                                        ...
                                        <td>{{ $department->DE_InitialSalary }}</td>
                                        <td>
