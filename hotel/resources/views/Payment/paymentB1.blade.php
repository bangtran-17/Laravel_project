...
<head>
  ...
  <link rel="stylesheet" href="https://fonts.googleapis.com/css2?family=Palatino Linotype:wght@400;700&display=swap" />
      ...
      <div class="frame1">
        <div class="navigation-header">
          ...
          <div class="ch-logo-vng-1-container">
            <img class="ch-logo-vng-12" alt="" src="{{asset('img/payment/ch-logo-vng-1@2x.png')}}" />

            <img class="logo-ko-ch-k-n-12" alt="" src="{{asset('img/payment/logo-ko-ch-k-n-1@2x.png')}}" />
          </div>
        </div>
      </div>
      <div class="frame2">
          ...
          <div class="frame9">
            <div class="frame10">
              <div class="frame11">
                <div class="input2">
                  <div class="h">Tên</div>
                  <input class="input-child" placeholder="Gia Lộc" type="text" name="G_Name" />
                </div>
                <div class="input3">
                  <div class="h">Email</div>
                  <input class="input-child" placeholder="lochoanggia@gmail.com" type="email" name="G_Email" />
                </div>
                <div class="input4">
                  <div class="h">Số điện thoại</div>
                  <input class="input-child" placeholder="0867533693" type="tel" name="G_SDT" />
                  <div class="input7">
                    <div class="h">Ngày Check-in</div>
                    <input class="input-child" placeholder="12/12/2023" type="date" name="check_in_date" />
                  </div>
                  <div class="input8">
                    <div class="h">Ngày Check-out</div>
                    <input class="input-child" placeholder="13/12/2023" type="date" name="check_out_date" />
                  </div>
                </div>
              </div>
